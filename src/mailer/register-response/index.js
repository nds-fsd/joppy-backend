                            ...
                            <tr>
                              ...
                              >
                                <h1
                                  ...
                                  "
                                >
                                  <strong>Welcome to DevRadar, </strong><br /><strong
                                    ><%= data.name %>!</strong
                                  >
                                </h1>
                              </td>
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p style="font-size: 14px; line-height: 150%">
                                    <span style="font-size: 20px; line-height: 30px; color: #5d49d6"
                                      ><strong
                                        ><span
                                          style="
                                            font-family: arial;
                                            ...
                                            font-size: 20px;
                                          "
                                          >Thanks for joining our community!</span
                                        ></strong
                                      ></span
                                    >
                                  </p>
                                ...
                                <div align="center">
                                  ...
                                  <a
                                    ...
                                    style="
                                      ...
                                      word-break: break-word;
                                      word-wrap: break-word;
                                      border-top-color: #5d49d6;
                                      border-top-style: solid;
                                      border-top-width: 2px;
                                      border-left-color: #5d49d6;
                                      border-left-style: solid;
                                      border-left-width: 2px;
                                      border-right-color: #5d49d6;
                                      border-right-style: solid;
                                      border-right-width: 2px;
                                      border-bottom-color: #5d49d6;
                                    ...
                                    <li style="font-size: 14px; line-height: 25.2px">
                                      <span
                                        style="
                                          ...
                                          line-height: 25.2px;
                                        "
                                        >Complete your profile with your information and
                                        preferences.</span
                                      >
                                    </li>
                                    <li style="font-size: 14px; line-height: 25.2px">
                                      <span
                                        style="
                                          ...
                                          line-height: 25.2px;
                                        "
                                        >Start surfing through the offers and save the ones that
                                        match your criteria.</span
                                      >
                                    </li>
                                    <li style="font-size: 14px; line-height: 25.2px">
                                      <span
                                        style="
                                          ...
                                          line-height: 25.2px;
                                        "
                                        >The company will receive your application and send you a
                                        response.</span
                                      >
                                    </li>
                                    <li style="font-size: 14px; line-height: 25.2px">
                                      <span
                                        style="
                                          ...
                                          line-height: 25.2px;
                                        "
                                        >If the company accepts your application, you will be able
                                        to open the chat with the recruiters.</span
                                      >
                                    </li>
                                  </ul>
                                </div>
...
`;
const registerHtml = String(html);
